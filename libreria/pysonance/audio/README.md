...
el objetivo será crear modulos que encapsulen las señales y mandar las entradas de los modulos a las entradas de las señales y las salidas de las señales a las salidas de los modulos
...
Otra opción es hacer un Signal que sea un virtual mic
creo que esta opción es más simple